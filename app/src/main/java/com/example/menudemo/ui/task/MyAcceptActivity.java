                    ...
                    if (msg.what == 0x12) {
                        ...
                        try {
                            ...
                            for(i=0;i<js.size();i++)
                            {
                                ...
                                String acceptor = js.getJSONObject(i).getString("acceptor");
                                ...
                                //获取RecyclerView
                                recy=findViewById(R.id.myaccepttask_rec);

                                LinearLayoutManager layoutManager = new LinearLayoutManager(MyAcceptActivity.this);
                                recy.setLayoutManager(layoutManager);
                                //创建adapter
                                Log.i("mytaskList:",taskList.toString());
                                taskAdapter = new MyAcceptAdapter(MyAcceptActivity.this,taskList);
                                //set adapter
