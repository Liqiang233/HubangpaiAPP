...
public class Task {
    ...
    public int getMessionid() {
        return messionid;
    }

    public void setMessionid(int messionid) {
    ...
    public Task( String messionname, String messiontype,
    ...
    public Task(int messionid, String messionname, String messiontype,
